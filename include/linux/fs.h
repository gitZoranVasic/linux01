...
struct m_inode {
	unsigned short i_mode; //i_mode
	unsigned short i_uid;
	unsigned long i_size; //velicina fajla
...
/* these are in memory also */
	...
	unsigned short i_dev; //disk na kome se nalazi fajl (za l001) je 0x301
	unsigned short i_num;	//broj inode-a
	unsigned short i_count; 
	unsigned char i_lock;
	unsigned char i_dirt; //da li je fajl modifikovan
